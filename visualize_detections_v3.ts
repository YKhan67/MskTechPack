...
async function visualize() {
    ...
    await image.write('/home/agent-engineer/maryam-tech-pack/detections_visualized_v3.png');
    console.log("Visualization saved to detections_visualized_v3.png");
}
